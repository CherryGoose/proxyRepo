...
namespace TestProject.Web.Menus;

public class TestProjectMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public TestProjectMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<TestProjectResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                TestProjectMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
